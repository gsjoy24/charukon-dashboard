...
const BannerManagement = () => {
	...
	if (error) return <div className='text-red-500 text-center'>Error loading banners!</div>;
			...
			<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
				{banners &&
					banners?.data?.map((banner) => (
						<div key={banner._id} className='border rounded-lg shadow-lg p-4 text-center space-y-2 relative'>
							{/* */}
							<img
								src={banner.url}
								alt='Banner'
								...
								onError={(e) => {
									return (e.target.src = "https://placehold.co/400x200/gray/white?text=Image%20Not%20Found");
								}}
							/>
